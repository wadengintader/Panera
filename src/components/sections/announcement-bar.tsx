...
const AnnouncementBar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-[#576c1d] border-b border-[#576c1d]/30 py-1.5 px-4 shadow-[0_4px_20px_rgba(0,0,0,0.3)] backdrop-blur-md">
        ...
        <div className="flex items-center justify-center gap-3">
            <div className="flex items-center justify-center gap-2 text-center">
              ...
              <p className="text-[#ffffff] text-[12px] font-bold tracking-tight text-center">
                ...
                minutes left to unlock your Panera Bread reward
              </p>
            </div>
        </div>
